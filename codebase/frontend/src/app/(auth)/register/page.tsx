        ...
        >
          ...
          <Card className="glass-panel border-white/5 shadow-2xl">
            <CardHeader className="text-center pb-2">
              <CardTitle className="text-gradient-premium text-2xl font-bold">Create Account</CardTitle>
              <CardDescription>Launch your automated social publishing today</CardDescription>
            </CardHeader>
            ...
            <CardContent>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <Button variant="primary" type="submit" isLoading={isLoading} className="mt-4 w-full">
                  Create Free Account
                </Button>
              </form>
            </CardContent>
